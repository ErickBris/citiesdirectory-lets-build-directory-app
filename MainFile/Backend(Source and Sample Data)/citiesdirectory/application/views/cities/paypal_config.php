			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input class="form-control" type="text" placeholder="price" name='price' id='price' value='<?php echo $paypal_config->price; ?>'>
					</div>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" placeholder="currency" name='currency' id='currency' value='<?php echo $paypal_config->currency_code; ?>'>
					</div>	
					<div class="form-group">
