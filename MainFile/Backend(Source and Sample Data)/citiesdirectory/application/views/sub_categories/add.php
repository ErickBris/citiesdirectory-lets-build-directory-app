				...
				<div class="row">
					<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Sub Category Name" name='name' id='name'>
							</div>
							<div class="form-group">
					...
					$('#sub_category-form').validate({
						rules:{
							name:{
								required: true,
								minlength: 2,
								remote: '<?php echo site_url("sub_categories/exists/" . $this->city->get_current_city()->id);?>'
							}
						},
						messages:{
							name:{
