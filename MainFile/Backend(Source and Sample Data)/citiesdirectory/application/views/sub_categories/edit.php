				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" placeholder="sub_category Name" name='name' id='name' value='<?php echo $sub_category->name;?>'>
						</div>
						<div class="form-group">
							...
							<input class="form-control" type="text" placeholder="Ordering" name='ordering' id='ordering'
								value='<?php echo $sub_category->ordering;?>'>
						</div>
